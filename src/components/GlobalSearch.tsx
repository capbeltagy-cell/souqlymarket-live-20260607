            ...
            <div className="p-2 text-sm">
              <Group
                ...
                items={res.companies.map((c: any) => ({
                  ...
                  sub: [c.industry, c.governorate].filter(Boolean).join(" · "),
                }))}
                q={q}
              ...
              <Group
                ...
                items={res.real_estate.map((l: any) => ({
                  ...
                  params: { id: l.id },
                  title: ar ? l.title_ar : l.title_en,
                  sub: [l.governorate, l.city].filter(Boolean).join(" · "),
                }))}
                q={q}
                onPick={() => setOpen(false)}
              />
              ...
              <Group
                ...
                items={res.factories.map((f: any) => ({
                  ...
                  sub: f.production_capacity ?? f.companies?.governorate ?? "",
                }))}
                q={q}
                onPick={() => setOpen(false)}
              />
              <Group
                ...
                items={res.wholesale.map((w: any) => ({
                  ...
                  params: { id: w.id },
                  title: w.title,
                  sub: w.price_per_unit
                    ? `${w.price_per_unit} ${w.currency || "EGP"}`
                    : w.governorate,
                }))}
                q={q}
                onPick={() => setOpen(false)}
