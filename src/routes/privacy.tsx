  ...
  head: () => ({
    meta: [
      { title: "سياسة الخصوصية — سوقلي | Privacy Policy" },
      {
        name: "description",
        content:
          "كيف يجمع سوقلي بيانات المستخدمين ويحميها: ما الذي نخزّنه، كيف نستخدمه، مع مَن نشاركه، وما هي حقوقك في التعديل أو الحذف.",
      },
      { property: "og:title", content: "سياسة الخصوصية — سوقلي" },
      {
        property: "og:description",
        content: "التزامنا بحماية بياناتك على منصة سوقلي B2B — جمع، استخدام، ومشاركة المعلومات.",
      },
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="container-souqly py-12 flex-1 max-w-3xl text-right">
        ...
        <div className="space-y-4 text-muted-foreground leading-loose">
          <p>
            نحن في سوقلي نلتزم بحماية خصوصية مستخدمينا. هذه السياسة توضح كيفية جمع واستخدام بياناتك.
          </p>
          ...
          <p>
            لا نبيع بياناتك لأي طرف ثالث. قد تُعرض بيانات الاتصال الخاصة بشركتك للمشترين المهتمين.
          </p>
