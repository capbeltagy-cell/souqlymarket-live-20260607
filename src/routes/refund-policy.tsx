    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="container-souqly py-12 flex-1 max-w-3xl text-right">
        ...
        <div className="space-y-4 text-muted-foreground leading-loose">
          ...
          <p>يمكنك إلغاء اشتراكك في أي وقت. لن يتم تجديد الاشتراك تلقائياً بعد الإلغاء، ولا يحق استرداد المبلغ المدفوع للفترة الحالية.</p>
          ...
          <p>في حال وجود مشكلة تقنية منعت تقديم الخدمة، يُرجى التواصل معنا خلال 7 أيام على support@souqlymarket.com لمراجعة الحالة.</p>
        </div>
      </main>
      <SiteFooter />
    </div>
