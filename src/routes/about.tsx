  ...
  head: () => ({
    meta: [
      { title: "من نحن — سوقلي | About Souqly" },
      {
        name: "description",
        content:
          "تعرّف على سوقلي، أول سوق B2B متخصص يربط الشركات المصرية والمصانع والموردين بالمشترين ووكلاء المبيعات في منصة واحدة موثوقة.",
      },
      { property: "og:title", content: "من نحن — سوقلي | About Souqly" },
      {
        property: "og:description",
        content:
          "قصتنا ورسالتنا: تمكين الشركات المصرية بمنصة B2B احترافية تفتح أسواقاً جديدة وتسهّل الصفقات بين الشركات.",
      },
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="container-souqly py-12 flex-1 prose prose-slate max-w-3xl rtl text-right">
        ...
        <p className="text-muted-foreground leading-loose">
          <strong>سوقلي</strong> هو السوق الإلكتروني المتخصص لرجال الأعمال والشركات في مصر. نربط
          المصانع والموردين والخدمات والمشترين في منصة واحدة آمنة وموثوقة.
        </p>
        <h2 className="text-xl font-semibold mt-8 mb-3">رسالتنا</h2>
        <p className="text-muted-foreground leading-loose">
          تمكين الاقتصاد المصري من خلال توفير منصة B2B احترافية تسهل التواصل التجاري بين الشركات
          وتفتح أسواقاً جديدة.
        </p>
