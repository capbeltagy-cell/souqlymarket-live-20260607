        ...
        {step === 1 && (
          <div className="rounded-xl bg-card border border-border p-6 space-y-4">
            ...
            <div>
              ...
              <Input value={form.slug} onChange={(e) => setForm({ ...form, slug: e.target.value.toLowerCase().replace(/[^a-z0-9-]/g, "-") })} placeholder="my-store" />
              {form.slug && <p className="text-xs text-muted-foreground mt-1">/stores/{form.slug}</p>}
            </div>
            <div>
            ...
            <div>
              ...
              <Textarea value={form.description_ar} onChange={(e) => setForm({ ...form, description_ar: e.target.value })} rows={4} />
            </div>
            ...
            <Button className="w-full" onClick={() => setStep(2)} disabled={!form.name_ar || !form.slug}>التالي</Button>
          </div>
        )}
        ...
        {step === 3 && (
          <div className="rounded-xl bg-card border border-border p-6 space-y-4">
            ...
            <div className="flex gap-2">
              ...
              <Button className="flex-1" onClick={() => save(true)} disabled={saving}>إرسال للمراجعة</Button>
            </div>
          </div>
        )}
      </div>
