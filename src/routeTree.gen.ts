...
import { Route as ApiPaymobWebhookRouteImport } from './routes/api.paymob.webhook'
...
const AuthenticatedCompanyCenterRoute =
  AuthenticatedCompanyCenterRouteImport.update({
    id: '/company-center',
    path: '/company-center',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any)
...
const AuthenticatedStoreOpenRoute = AuthenticatedStoreOpenRouteImport.update({
  id: '/store/open',
  path: '/store/open',
  getParentRoute: () => AuthenticatedRouteRoute,
} as any)
...
const ApiPaymobWebhookRoute = ApiPaymobWebhookRouteImport.update({
  id: '/api/paymob/webhook',
...
export interface FileRoutesByFullPath {
  ...
  '/api/paymob/webhook': typeof ApiPaymobWebhookRoute
...
export interface RootRouteChildren {
  ...
  ApiPaymobWebhookRoute: typeof ApiPaymobWebhookRoute
}
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/company-center': {
      id: '/_authenticated/company-center'
      path: '/company-center'
      fullPath: '/company-center'
    ...
    '/api/paymob/webhook': {
      id: '/api/paymob/webhook'
      path: '/api/paymob/webhook'
      fullPath: '/api/paymob/webhook'
      preLoaderRoute: typeof ApiPaymobWebhookRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/_authenticated/listings/$id/edit': {
...
const rootRouteChildren: RootRouteChildren = {
  ...
  ApiPaymobWebhookRoute: ApiPaymobWebhookRoute,
}
